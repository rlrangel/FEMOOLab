...
% implementation of *Second-Order Finite Difference Scheme* of numerical
% time integration.
%
...
%
% Ref.:
% A survey of direct time-integration methods in computational
...
% [Z] = 1/(dt^2)*[M] - 1/(2dt)*[C]
%
classdef Scheme_FD2 < Scheme
    %% Constructor method
    methods
        function this = Scheme_FD2()
            this = this@Scheme(Scheme.CENTRAL_DIFFERENCE,2);
        end
    end
