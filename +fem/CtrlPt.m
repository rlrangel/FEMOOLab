...
classdef CtrlPt < handle
    ...
    properties (SetAccess = public, GetAccess = public)
        ...
        elems  fem.Element_Isogeometric = fem.Element_Isogeometric.empty; % vector of objects of Element_Isoparametric class (incident elements)
